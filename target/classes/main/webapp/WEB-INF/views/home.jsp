        ...
        <div class="container_nav_block_outer">
            <div class="container_nav_block_inner">
                <div class="container_nav_search_task">
                    <form action="/search" class="container_nav_search_task_table" method="post">
                        <input class="container_nav_search" type="text"
                               placeholder="Tìm kiếm" id="search" name="filter">
                        <input type="submit" class="container_nav_btn_submit">
